...
REGISTERMAINFILE_NAME = "catch_registerstaticlibrary.cpp"

KNOWN_CPP_EXTENSIONS = ["cpp", "cc", "cxx"]
...
def does_sourcefile_implement_tests(lines):
    ...
    for line in lines:
        ...
        for catch_usage_hint in CPP_TESTFILE_HINTS:
...
def register_main_file(source_files):
    ...
    for guid in guid_list:
        declare_register_functions_code += "int catchRegister_" + guid + "();\n"
        call_register_functions_code += "  dummy_sum += catchRegister_" + guid + "();\n"
    ...
    help_message = """
        Usage :
            ...
            _command_ -registermainfile file1.cpp file2.cpp file3.cpp ...
                Will create a the main register file with one function that calls all catchRegister_GUID() functions
    """
